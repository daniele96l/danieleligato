  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        approach: 'Used ensemble models (XGBoost) for top-level aggregates where accuracy matters most, and LightGBM for the thousands of low-level time series where speed is critical. Hierarchical reconciliation ensures forecasts sum correctly across all levels.',
        techStack: ['Python', 'XGBoost', 'LightGBM', 'GCP', 'Docker', 'CI/CD'],
        keyInsights: [
          'XGBoost for top-level: slower but more accurate on key revenue metrics',
          'LightGBM for bottom-level: handles high volume efficiently',
